    ...
    <div className="pt-0 md:pt-20 bg-background overflow-x-clip">
      <section className="relative isolate overflow-hidden bg-charcoal text-primary-foreground section-padding">
        ...
        <div className="container-wide relative z-10 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
          <SectionFadeIn>
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black leading-[0.96]">
              Research and Consulting
            </h1>
            <p className="mt-6 max-w-2xl text-primary-foreground/80 text-base md:text-lg leading-relaxed">
              The Centre is to monitor and administer Research programs for
              faculty and students and to encourage them to be focused on
              research activities by providing the necessary infrastructural set
              up including reputed journals and information materials on timely
              basis to facilitate quality research output. The objectives of the
              Cell are to Create and promote a culture of research among the
              faculty and staff , to organize various workshops/ seminars/
              trainings related to promotion of research, to enhance the
              research output of the institute by research paper publication in
              referred journals and reputed conferences, to publish an
              ISSN/refereed research journal of the college on annual basis, to
              facilitate application of research projects and to encourage and
              motivate seminar and conference participations and paper
              presentations.
            </p>
          </SectionFadeIn>
          ...
          <SectionFadeIn>
            <div className="relative overflow-hidden rounded-[1.8rem] border border-charcoal/20 bg-charcoal p-6 md:p-8 md:p-10 shadow-[0_24px_70px_rgba(2,8,23,0.22)]">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl md:text-4xl font-black text-primary-foreground">
                  Hence ASB's focused functions are:
                </h2>
                ...
                <div className="mt-8 relative">
                  ...
                  <div className="space-y-4 md:space-y-5">
                    {focusedFunctions.map((item, index) => (
                      <div
                        key={item}
                        className="relative md:grid md:grid-cols-[1fr_auto_1fr] md:items-stretch md:gap-5"
                      >
                        <div
                          className={
                            index % 2 === 0
                        ...
                        >
                          <div className="group relative h-full overflow-hidden rounded-2xl border border-primary/35 bg-white/10 backdrop-blur-sm transition-all duration-300 hover:border-primary/70 hover:bg-white/15 hover:-translate-y-1">
                            ...
                            <div className="relative flex items-start gap-3 px-4 py-4 md:px-5 md:py-5">
                              ...
                              <p className="text-sm md:text-[0.95rem] text-primary-foreground/90 leading-relaxed">
                                {item}
                              </p>
                            </div>
                          </div>
