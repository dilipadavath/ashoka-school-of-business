...
const InternalQualityAssuranceCellPage = () => {
  return (
    <main className="pt-0 md:pt-20 bg-background overflow-x-clip">
      <section className="relative overflow-hidden border-b border-border bg-[radial-gradient(circle_at_14%_18%,rgba(220,38,38,0.2),transparent_42%),radial-gradient(circle_at_84%_10%,rgba(2,132,199,0.18),transparent_40%),linear-gradient(145deg,#0f172a,#1e293b)] text-primary-foreground section-padding">
          ...
          <SectionFadeIn>
            <div className="max-w-4xl">
              ...
              <p className="mt-5 text-sm md:text-base leading-relaxed text-primary-foreground/90">
                In compliance with the AICTE norms and to ensure that quality
                education is imparted to the students, Ashoka School of Business
                (ASB) established Internal Quality Assurance (IQAC) Cell that
                caters to the aspects such student&apos;s feedback on Teacher
                and Leader Effectiveness process, regular Academic audits,
                preparations for Accreditation of academic programs and
                processes etc.
              </p>
          ...
          <SectionFadeIn delay={0.1}>
            <div className="relative overflow-hidden rounded-[1.6rem] border border-primary/25 bg-white/10 p-6 shadow-[0_24px_60px_rgba(2,8,23,0.32)] backdrop-blur-sm">
              <div className="rounded-[1.2rem] border border-white/20 bg-white/10 p-6 md:p-7">
                <p className="text-xs font-black uppercase tracking-[0.24em] text-primary-foreground/80">
                  IQAC
                </p>
                <p className="mt-3 text-3xl md:text-4xl font-black leading-none">
                  Quality First
                </p>
                <p className="mt-4 text-sm md:text-base text-primary-foreground/85 leading-relaxed">
                  Regular academic audits, accreditation readiness, and
                  continuous quality checks across academic, administrative, and
        ...
        <div className="container-wide max-w-6xl mx-auto space-y-8">
              ...
              <div className="grid gap-6 lg:grid-cols-2">
                <div>
                  ...
                  <p className="mt-3 text-sm md:text-base text-muted-foreground">
                    The primary objectives of the Internal Quality Assurance
                    Cell (IQAC) are to...
                  </p>
                  <ul className="mt-5 space-y-3">
                    {objectiveItems.map((item, index) => (
                      <li
                        key={item}
                        className="flex items-start gap-3 rounded-2xl border border-border/60 bg-secondary/20 p-4"
                      >
          ...
          <SectionFadeIn delay={0.1}>
            <div className="rounded-3xl border border-border/70 bg-white/95 p-6 md:p-8 shadow-[0_16px_45px_rgba(15,23,42,0.08)] overflow-x-auto backdrop-blur-sm">
              <h3 className="text-2xl md:text-3xl font-black text-foreground">
                The following are the details of IQAC members:
              </h3>
