...
const allAarohanModules = import.meta.glob(
  "../assets/aarohan-2025/**/*.{png,jpg,jpeg,webp}",
  {
    eager: true,
    import: "default",
  },
...
const allAarohanVideos = import.meta.glob(
  "../assets/aarohan-2025/**/*.{mp4,webm,mov,avi,mkv}",
  {
    eager: true,
    import: "default",
  },
...
const aarohanDays = [
  ...
  },
  {
    day: "DAY 03",
    title:
      "A Session on Business Etiquette & Personal Branding and Panel Discussion on The Future of Work: Skills that Matter in 2025 and Beyond",
  ...
  },
  {
    day: "DAY 04",
    title:
      "Becoming a Better Negotiator — Fundamentals You Will Use Every Day and Emerging Technologies on AI & DS",
          ...
          <SectionFadeIn>
            <div className="max-w-4xl">
              ...
              <p className="mt-5 max-w-3xl text-sm md:text-base leading-relaxed text-primary-foreground/90">
                A 15-day high-energy orientation and induction program designed
                to ignite ambition, build community, and equip ASB students with
                the skills, mindset, and networks needed for a successful
                management career.
              </p>
      ...
      <section id="itinerary" className="section-padding bg-background">
        <div className="container-wide max-w-6xl">
          {aarohanDays.map((day, dayIndex) => (
            <SectionFadeIn
              key={dayIndex}
              delay={Math.min(dayIndex * 0.04, 0.3)}
            >
              <div className="mb-14">
                {/* Day header */}
                <div className="bg-primary text-primary-foreground px-6 py-4 rounded-t-lg">
                  ...
                  <h2 className="mt-1 text-lg md:text-xl font-black leading-snug">
                    {day.title}
                  </h2>
                </div>
