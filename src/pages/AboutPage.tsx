...
const AboutPage = () => {
  ...
  return (
    <div className="pt-20">
      {/* Hero */}
      <section className="relative overflow-hidden min-h-[240px] md:min-h-[320px] px-4 md:px-8 py-12 md:py-16">
        <img src={heroAbout} alt="About Ashoka School of Business" className="absolute inset-0 h-full w-full object-cover" />
      ...
      {/* About ASB */}
      <section id="about" className="section-padding bg-background scroll-mt-28">
        <div className="container-wide px-4">
          <SectionFadeIn>
            <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-10 items-start">
              <div className="max-w-2xl">
                <p className="text-primary font-semibold text-sm uppercase tracking-[0.28em] mb-4">Why Choose Us</p>
                <h2 className="text-3xl md:text-5xl font-black text-foreground mb-6">ABOUT ASB</h2>
              ...
              <div className="grid grid-cols-[0.72fr_1fr] gap-4 lg:gap-5">
                <div className="pt-10 md:pt-14">
                  <div className="overflow-hidden rounded-[1.75rem] shadow-xl shadow-slate-900/10">
                    <img src={aboutImg1} alt="ASB students and faculty" className="h-full w-full object-cover" />
                  </div>
                </div>
                <div className="relative overflow-hidden rounded-[1.75rem] shadow-xl shadow-slate-900/10 min-h-[360px] md:min-h-[460px]">
                  <img src={aboutImg2} alt="Ashoka School of Business boardroom" className="absolute inset-0 h-full w-full object-cover" />
                  ...
                  <Dialog open={isVideoOpen} onOpenChange={setIsVideoOpen}>
                    ...
                    <DialogContent showCloseButton={false} className="max-w-[min(1100px,calc(100vw-2rem))] overflow-visible border-white/10 bg-black p-0 shadow-2xl">
                      ...
                      <DialogTitle className="sr-only">Why Healthcare Management at ASB?</DialogTitle>
        ...
        <div className="container-wide px-4">
          <SectionFadeIn>
            <div className="text-center mb-14">
              <p className="text-primary font-semibold text-sm uppercase tracking-[0.28em] mb-3">Founder</p>
              <h2 className="text-3xl md:text-5xl font-black text-foreground">Message</h2>
            </div>
          </SectionFadeIn>

          <div className="max-w-6xl mx-auto">
            <SectionFadeIn>
              <section id="founder-chairman-message" className="scroll-mt-28 grid lg:grid-cols-[280px_1fr] gap-8 lg:gap-12 items-start">
                <div className="rounded-[2rem] border border-border bg-secondary p-6 md:p-8 text-center shadow-lg shadow-slate-900/5">
                  <div className="mx-auto mb-6 h-44 w-44 overflow-hidden rounded-[2rem] shadow-lg shadow-slate-900/10 ring-1 ring-border/60">
                    <img src={founderChairmanImg} alt="Founder and Chairman Nomula Ashok Kumar" className="h-full w-full object-cover object-top" />
                  </div>
                  <p className="text-xs font-semibold uppercase tracking-[0.24em] text-primary mb-2">Founder and Chairman</p>
                  <h3 className="text-2xl font-black text-foreground leading-tight">Nomula Ashok Kumar</h3>
                </div>

                <div className="rounded-[2rem] border border-border bg-background p-6 md:p-10 shadow-lg shadow-slate-900/5">
                  <div className="flex items-center gap-3 mb-4">
                    <GraduationCap className="h-6 w-6 text-primary" />
                    <span className="text-sm text-primary font-semibold uppercase tracking-[0.22em]">Founder and Chairman</span>
                  </div>
                  <div className="space-y-5 text-muted-foreground text-lg leading-relaxed">
                    <p>
                      Since the inception of Ashoka School Business our aim is to provide a scholastically exhilarating environment consenting our students to feel more responsible towards the society. It is pleasing to note that our intensive efforts under the auspices of Ashok Sailaja Educational Society have fructified and ASB today enjoys the distinction in the fields of Management Education with Tech-enabled Industry demand programs. Our beliefs have influenced the way of teaching and make the students participate in philanthropy and social welfare. I have realized that there can’t be a nobler act than to lead an educational institute like ASHOKA.
                    </p>
                    <p>
