        ...
        <div className="container-wide relative z-10">
          <div className="grid items-center gap-10 lg:grid-cols-12">
            <SectionFadeIn className="lg:col-span-7">
              <p className="text-primary font-semibold text-sm uppercase tracking-[0.24em] mb-4">
                Director&apos;s Message
              </p>
              ...
              <p className="mt-7 max-w-2xl text-primary-foreground/75 text-base md:text-lg leading-relaxed">
                Visionary leadership focused on industry readiness, ethical
                values, and transformative management education.
              </p>
            </SectionFadeIn>
              ...
              <div className="relative mx-auto max-w-sm lg:max-w-none">
                ...
                <div className="relative overflow-hidden rounded-[2rem] border border-primary/30 bg-charcoal/70 p-3 shadow-[0_20px_70px_rgba(0,0,0,0.45)]">
                  ...
                  <div className="px-2 pb-2 pt-4">
                    ...
                    <p className="mt-1 text-base md:text-lg font-bold text-primary-foreground">
                      Dr. Y Lakshman Kumar
                    </p>
                  </div>
                </div>
              ...
              <div className="grid items-start gap-8 lg:grid-cols-[260px_1fr] lg:gap-12">
                  ...
                  <div className="mt-5 space-y-3">
                    <div className="rounded-xl border border-border/70 bg-secondary/65 px-4 py-3">
                      ...
                      <p className="mt-1 text-sm font-semibold text-foreground">
                        Leadership with confidence, competence, and conscience
                      </p>
                    </div>
                    <div className="rounded-xl border border-border/70 bg-secondary/65 px-4 py-3">
                      <p className="text-[0.65rem] uppercase tracking-[0.2em] text-muted-foreground">
                ...
                <article className="rounded-[1.6rem] border border-border/70 bg-white p-6 md:p-8">
                  <blockquote className="border-l-4 border-primary pl-4 md:pl-5 text-base md:text-lg text-foreground font-medium leading-relaxed">
                    At ASB, learning goes beyond the classroom. You are
                    empowered to lead, create, and transform with purpose.
                  </blockquote>
                  ...
                  <div className="mt-6 space-y-6 text-base md:text-lg leading-relaxed text-muted-foreground">
                    <p className="first-letter:float-left first-letter:mr-2 first-letter:text-4xl first-letter:font-black first-letter:text-foreground first-letter:leading-none">
                      It is my pleasure to welcome you to ASB, where we are
                      dedicated to shaping not just professionals, but visionary
                      leaders equipped to thrive in a dynamic global business
                      environment. The two-year PGDM &amp; PGDM (AI&amp;DS)
                      programs at ASB is a transformative journey that blends
                      rigorous academic training with immersive industry
                      exposure, preparing you to lead with confidence,
                      competence, and conscience.
                    </p>
                    <p>
                      Our carefully crafted curriculum, designed in
                      collaboration with top academicians and industry leaders,
                      focuses on strengthening both core and functional business
                      knowledge. Complementing this are value-added
                      certifications, aptitude and personality development
                      sessions, language and communication training, and
                      hands-on simulations that enhance your readiness for
                      real-world challenges.
                    </p>
                    <p>
                      Weekly interactions with corporate leaders, intensive
                      mentoring, and the unique "Executives in Residence" series
                      provide invaluable industry insight. In addition to
                      academics, we strongly encourage participation in
                      student-led clubs and events that let you apply management
                      principles in cultural, financial, marketing, HR and
                      agribusiness management.
                    </p>
                    <p>
                      At ASB, learning goes beyond the classroom and offers you
                      the independence and responsibility to lead, create, and
                      transform. This is your opportunity to engage deeply,
                      evolve holistically, and realize the full potential that
                      lies within you. Seize it with purpose, passion, and
                      persistence.
                    </p>
                  </div>
