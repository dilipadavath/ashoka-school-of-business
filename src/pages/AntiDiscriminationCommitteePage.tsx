...
import committeeImage from "@/assets/anti-descrimination.jpeg";
          ...
          <SectionFadeIn>
            <div className="max-w-4xl">
              ...
              <p className="mt-5 text-sm md:text-base leading-relaxed text-primary-foreground/90">
                Establishment of committee for SC/ST (As per the scheduled
          ...
          <SectionFadeIn delay={0.12}>
            <div className="relative overflow-hidden rounded-[1.6rem] border border-primary/25 bg-white/10 p-3 shadow-[0_24px_60px_rgba(2,8,23,0.32)] backdrop-blur-sm">
              <div className="overflow-hidden rounded-[1.2rem] border border-white/10 bg-secondary aspect-[4/3]">
                <img
                  src={committeeImage}
                  alt="Anti-Discrimination Committee"
          ...
          <SectionFadeIn>
            <div className="rounded-3xl border border-border/70 bg-white/95 p-6 md:p-8 shadow-[0_16px_45px_rgba(15,23,42,0.08)] backdrop-blur-sm space-y-5">
              ...
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                ...
                institute promotes the special interests of students in the
                reserved category; it is expected to provide special inputs in
                areas where the students experience difficulties.
              </p>
              ...
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                The cell may conduct regular remedial coaching classes on life
                skills, personality development, writing assignments, and making
                presentations, as well as English and local language classes.
                The cell is also expected to organize interactive sessions and
                informal meetings with students to attend to their personal,
                social, and academic problems. Guide the SC/ST/OBC/PWD students
                of the institute to optimally utilize the benefits of the
                schemes offered by the state governments, the government of
                India (GOI), and the UGC.
              </p>
            </div>
          </SectionFadeIn>
