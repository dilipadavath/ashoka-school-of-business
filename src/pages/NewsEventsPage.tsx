...
const nestedNewsEventModules = import.meta.glob(
  "@/assets/news-events/**/*.{webp,png,jpg,jpeg}",
  {
    eager: true,
    import: "default",
  },
...
const aimaGallery = groupImages(
  [/^dsc086/, /^dsc087/, /^dsc088/, /^dsc090/],
  9,
);
const seminarGallery = getImagesFromNewsSubFolder(
  "Student's Participated and Presented Research",
);
...
const NewsEventsPage = () => {
  ...
  return (
    <main className="pt-0 md:pt-20 bg-[#ececec] overflow-x-clip">
        ...
        <div className="container-wide relative z-10 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
          <SectionFadeIn>
            <div className="max-w-4xl">
              ...
              <h1 className="mt-5 text-3xl md:text-5xl font-black leading-tight uppercase">
                News &amp; Events
              </h1>
      ...
      <section className="section-padding">
        <div className="container-wide max-w-5xl mx-auto space-y-10 md:space-y-14">
          <SectionFadeIn>
            ...
            <div className="mx-auto mt-6 max-w-3xl rounded-[1.4rem] border border-black/10 bg-[linear-gradient(145deg,#ffffff,#f3f4f6)] p-3 md:p-5 shadow-[0_20px_50px_rgba(2,8,23,0.12)]">
              <div className="rounded-[1rem] border border-black/10 bg-white p-2 md:p-3 shadow-[0_10px_24px_rgba(2,8,23,0.12)]">
                <img
                  src={newsPrimaryImage}
                  alt="News events image 1"
          ...
          <SectionFadeIn delay={0.05}>
            ...
            <div className="mt-5">
              <ImageGrid
                images={directNewsEventsGallery}
                onImageClick={(index) =>
                  openPreview(directNewsEventsGallery, index)
                }
              />
            </div>
          </SectionFadeIn>
          ...
          <SectionFadeIn delay={0.08}>
            ...
            <div className="mt-5">
              <ImageGrid
                ...
                onImageClick={(index) => openPreview(seminarGallery, index)}
              />
            </div>
          </SectionFadeIn>
          ...
          <SectionFadeIn delay={0.1}>
            ...
            <div className="mt-5">
              <ImageGrid
                images={hmaGallery}
                onImageClick={(index) => openPreview(hmaGallery, index)}
              />
            </div>
          </SectionFadeIn>
          ...
          <SectionFadeIn delay={0.12}>
            ...
            <div className="mt-5">
              <ImageGrid
                images={icmmetcGallery}
                onImageClick={(index) => openPreview(icmmetcGallery, index)}
              />
            </div>
          </SectionFadeIn>
        </div>
