  ...
  return (
    <div className="pt-20 bg-background overflow-x-clip">
      <section className="relative isolate overflow-hidden bg-charcoal text-primary-foreground px-4 md:px-8 py-14 md:py-20">
        ...
        <div className="container-wide relative z-10 px-4 grid gap-10 items-center">
          <SectionFadeIn>
            ...
            <p className="mt-6 max-w-3xl text-primary-foreground/75 text-base md:text-lg leading-relaxed">
              ASB partners with Infosys Springboard, offering access to over 70,000 industry-relevant courses to equip
              students with essential technical and professional skills.
            </p>
          </SectionFadeIn>
        </div>
      </section>
