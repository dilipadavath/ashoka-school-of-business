          ...
          <SectionFadeIn>
            <div className="max-w-4xl">
              ...
              <p className="mt-5 text-sm md:text-base leading-relaxed text-primary-foreground/90">
                Ashoka School of Business (ASB) respects your privacy. This
        ...
        <div className="container-wide max-w-5xl mx-auto space-y-8">
          <SectionFadeIn>
            <div className="rounded-3xl border border-border/70 bg-white/95 p-6 md:p-8 shadow-[0_16px_45px_rgba(15,23,42,0.08)] backdrop-blur-sm">
              ...
              <p className="mt-4 text-sm md:text-base leading-relaxed text-muted-foreground">
                Ashoka School of Business ("ASB", "we", "our", "us") respects
                your privacy. This policy describes how we collect, use, and
                protect your personal information when you visit or interact
                with our website at asb.org.in.
              </p>
            </div>
          </SectionFadeIn>
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-2">
                <div className="rounded-2xl border border-border bg-secondary/20 p-5">
                  ...
                  <p className="mt-3 text-sm md:text-base leading-relaxed text-muted-foreground">
                    Name, email, phone number, address, and academic details
                    submitted through inquiries, applications, subscriptions, or
                    events.
                  </p>
                </div>
                <div className="rounded-2xl border border-border bg-secondary/20 p-5">
                  ...
                  <p className="mt-3 text-sm md:text-base leading-relaxed text-muted-foreground">
                    IP address, browser type, usage logs, and cookie data,
                    including analytics tools such as Google Analytics or
                    similar services.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-3xl border border-border/70 bg-white/95 p-6 md:p-8 shadow-[0_16px_45px_rgba(15,23,42,0.08)] backdrop-blur-sm">
              ...
              <ul className="mt-5 space-y-3 text-sm md:text-base leading-relaxed text-muted-foreground list-disc list-inside">
                ...
                <li>
                  ...
                  analytics and email partners, under confidentiality
                  commitments.
                </li>
              </ul>
            </div>
          ...
          <SectionFadeIn delay={0.16}>
            <div className="rounded-3xl border border-border/70 bg-white/95 p-6 md:p-8 shadow-[0_16px_45px_rgba(15,23,42,0.08)] backdrop-blur-sm">
              ...
              <p className="mt-4 text-sm md:text-base leading-relaxed text-muted-foreground">
                Our website uses cookies for site performance, analytics, and
                user experience. You can control or disable cookies through your
                browser settings.
              </p>
            </div>
          </SectionFadeIn>
          ...
          <SectionFadeIn delay={0.2}>
            <div className="rounded-3xl border border-border/70 bg-white/95 p-6 md:p-8 shadow-[0_16px_45px_rgba(15,23,42,0.08)] backdrop-blur-sm">
              ...
              <ul className="mt-5 space-y-3 text-sm md:text-base leading-relaxed text-muted-foreground list-disc list-inside">
                <li>
                  We retain personal data as needed for operational, legal, or
                  academic purposes.
                </li>
                <li>
          ...
          <SectionFadeIn delay={0.24}>
            <div className="rounded-3xl border border-border/70 bg-white/95 p-6 md:p-8 shadow-[0_16px_45px_rgba(15,23,42,0.08)] backdrop-blur-sm">
              ...
              <p className="mt-4 text-sm md:text-base leading-relaxed text-muted-foreground">
                We may update this policy from time to time. For privacy queries
                or requests, please contact us at:
              </p>
              <a
                href="mailto:info@asb.org.in"
