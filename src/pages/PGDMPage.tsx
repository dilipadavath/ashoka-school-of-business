    ...
    <div className="pt-0 md:pt-20">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground mt-6">
                  The curriculum equips students with management skills for
                  Hospitals, Industries, NGOs, IoT companies, and Equipment
                  manufacturing.
                </p>
              </div>
              <div>
        ...
        <div className="text-center px-4">
          <SectionFadeIn>
            <h2 className="text-3xl md:text-5xl font-black text-primary-foreground mb-4">
              Your Path to Management Excellence
            </h2>
            <p className="text-primary-foreground/70 text-lg max-w-2xl mx-auto">
              Join India's leading tech-blended PGDM program.
            </p>
          </SectionFadeIn>
        </div>
      </ParallaxSection>
          ...
          <SectionFadeIn>
            ...
            <div className="bg-background p-8 rounded-xl border border-border space-y-4">
              <p className="text-foreground">
                • Bachelor's degree of minimum 3 years duration in any
                discipline
              </p>
              <p className="text-foreground">
              ...
              <p className="text-foreground font-medium mt-4">
                Valid entrance test scores accepted:
              </p>
              ...
              <p className="text-muted-foreground text-sm">
                Any national or state level admission test is also accepted.
              </p>
            </div>
          </SectionFadeIn>
        </div>
        ...
        <div className="container-wide max-w-4xl mx-auto">
          <SectionFadeIn>
            ...
            <p className="text-center text-muted-foreground mb-8">
              Candidates can apply online or offline. Applicants must attend
              Group Discussion and Personal Interview. Application Fee:{" "}
      ...
      <section className="section-padding bg-secondary">
        <div className="container-wide max-w-3xl mx-auto">
          <SectionFadeIn>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              Fee Structure — PGDM (2026-2028)
            </h2>
            <div className="bg-background rounded-xl overflow-hidden border border-border">
              {feeStructure.map((row, i) => (
                <div
                  key={row.item}
                  className={`flex justify-between px-6 py-4 ${i % 2 === 0 ? "bg-secondary/50" : ""} ${(row as any).bold ? "font-bold border-t-2 border-primary" : ""}`}
                >
            ...
            <div className="mt-6 p-4 bg-background border border-border rounded-lg text-sm text-muted-foreground space-y-1">
              ...
              <p>
                Alumni Association Fee – ₹5,000 | Student Welfare Fee – ₹5,000
              </p>
